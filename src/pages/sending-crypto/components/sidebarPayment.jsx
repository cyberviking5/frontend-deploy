    ...
    <div className="sidebar">
      <div>
        ...
        <div className="links">
          ...
          <div className="payment" style={{ color: "white" }}>
            <Link to="/sending-crypto/paymentRealNumber">
              <div>
                ...
                >
                  <path
                    d="M14 3.50209H0.00823975V1.40332C0.00823975 1.01695 0.321459 0.703735 0.707827 0.703735H13.3004C13.6868 0.703735 14 1.01695 14 1.40332V3.50209ZM14 4.90126V12.5967C14 12.9831 13.6868 13.2963 13.3004 13.2963H0.707827C0.321459 13.2963 0.00823975 12.9831 0.00823975 12.5967V4.90126H14ZM6.30454 8.3992V6.65023L3.15638 9.79837H10.5021V8.3992H6.30454Z"
                    fill="#FEFFFF"
                  />
                </svg>
                <span className="link-name" style={{ verticalAlign: 0 }}>
          ...
          <div className="dVOIP">
            <Link to="/sending-crypto/dvoip-page">
              <div>
                {/* <div className='disabled'>       */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="link-name">dVOIP</span>
                <span className="coming_soon">Coming soon</span>
                {/* </div>     */}
              </div>{" "}
            </Link>
